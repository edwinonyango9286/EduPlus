...
export const addQuestion = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      //add this updated course to our course content
    ...
    try {
      ...
      if ((req as any).user?._id === question.user._id) {
        ...
        const html = await ejs.renderFile(
          path.join(__dirname, "../mails/guestion-reply.ejs"),
          data
        );
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const notification = {
        ...
        message: `${(req as any).user?.name} has given a review in ${
          course?.name
        }`,
      };
...
export const addRepplyToReview = CatchAsyncError(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
